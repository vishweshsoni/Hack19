...
import 'package:resume_builder/Pages/AutoGenrated.dart';
...
class _LoginBottomState extends State<LoginBottom> {
  ...
  static final CREATE_POST_URL ='http://hackflutter.herokuapp.com/signin';

  TextEditingController teEmail = new TextEditingController();
  TextEditingController tePassword = new TextEditingController();


  Future<Autogenerated> createPost(String url,{Map body}) async{
...
//                    });
                    ...
                    prefs.setString('email', teEmail.text);
                    Autogenerated autogen  = new Autogenerated(userEmail:teEmail.text, userPassword: tePassword.text);
                    print(teEmail.text);
                    print(tePassword.text);
                    Autogenerated a = await createPost(CREATE_POST_URL,body: {'user_email':teEmail.text,'user_password': tePassword.text});
                    print(a.userEmail);
                  },
